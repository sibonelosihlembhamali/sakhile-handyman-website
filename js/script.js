    ...
    if (plugins.swiper) {
      for (var i = 0; i < plugins.swiper.length; i++) {
        var sliderMarkup = plugins.swiper[i],
          ...
          pagNode =
            document.querySelector(pagSelector) ||
            sliderMarkup.querySelector(".swiper-pagination"),
          navNextSelector = sliderMarkup.getAttribute("data-next"),
          navPrevSelector = sliderMarkup.getAttribute("data-prev"),
          navNextNode =
            document.querySelector(navNextSelector) ||
            sliderMarkup.querySelector(".swiper-button-next"),
          navPrevNode =
            document.querySelector(navPrevSelector) ||
            sliderMarkup.querySelector(".swiper-button-prev"),
          swiper,
          options = {
